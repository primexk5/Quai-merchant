                ...
                <div className="flex flex-col items-center px-6 py-6 sm:px-8">
                  {isMobile ? (
                    <>
                      ...
                      <a href={blipLink} className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#C1ED00] py-3 text-sm font-semibold text-[#0F1116] transition hover:bg-[#d4ff00]">
                        <Smartphone size={15} />
                        Open in Blip
                      </a>
                    </>
                    ...
                    <>
                      <div className="mb-4 rounded-2xl bg-white p-3 shadow-md ring-4 ring-[#C1ED00]/20">
                        <QRCode value={blipLink} size={148} level="M" fgColor="#0F1116" />
                      </div>
